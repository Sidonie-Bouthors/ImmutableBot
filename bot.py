...
def xkcd(update, context):
  ...
  rand = requests.get(XKCD_URL1 + str(random.randint(1, curr_num)) + XKCD_URL2)
...
def main(): 
  ...
  autoSticker(supremacyPack["sacrejaune"],    "sacrejaune")
  ...
  autoSticker(supremacyPack["toxic pokemon"], "toxic", "pokemon")
  ...
  autoSticker(supremacyPack["ci-git"],        "ci-git")
  autoSticker(supremacyPack["ci-git mdr"],    "mort de rire")
  autoSticker(supremacyPack["behold jacopo"], "behold", "aggiudicato")
  autoSticker(supremacyPack["con des morts"], "con des morts")
  autoSticker(supremacyPack["allemand"],      "l'allemand")
  autoSticker(supremacyPack["francois punch"],"punch")
  autoSticker(supremacyPack["fuck"],          "fuck")
  autoSticker(supremacyPack["futur blanc"],   "futur blanc", "futur plus blanc")
  autoSticker(supremacyPack["jacopo dumb"],   "i was dumb")
  autoSticker(supremacyPack["jeanne beans"],  "beans")
  autoSticker(supremacyPack["jeanne man 1"],  "jeanne1")
  autoSticker(supremacyPack["jeanne man 2"],  "jeanne2")
  autoSticker(supremacyPack["jeanne man 3"],  "jeanne3")
  autoSticker(supremacyPack["jeanne"],        "damned")
